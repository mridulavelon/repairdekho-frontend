    ...
    <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
      ...
      <div>
        ...
        <p className="text-lg text-slate-600 max-w-xl leading-relaxed">
          Pick the perfect iPad for creativity, productivity, entertainment,
      ...
      <div className="relative flex justify-center md:justify-end">
        <div className="relative w-[320px] md:w-[420px]">
          <img
            src="https://images.jdmagicbox.com/quickquotes/images_main/apple_12_9_inch_ipad_pro_with_wi_fi_cellular_128gb_space_grey_11803882_0.jpg"
            alt="Apple iPad"
            width={300}
            height={300}
